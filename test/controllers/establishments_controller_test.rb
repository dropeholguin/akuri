...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post establishments_url, params: { establishment: { address: @establishment.address, kind_of_food: @establishment.kind_of_food, name: @establishment.name, phone: @establishment.phone, website: @establishment.website } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { address: @establishment.address, kind_of_food: @establishment.kind_of_food, name: @establishment.name, phone: @establishment.phone, website: @establishment.website } }
